    ...
    <header className="border-b border-slate-800/80 bg-slate-950/80 backdrop-blur-xl sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-18 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-red-600 via-rose-600 to-red-500 flex items-center justify-center shadow-lg shadow-red-500/20 ring-1 ring-white/20">
            <Zap className="w-5 h-5 text-white fill-white" />
          </div>
          <div>
            <div className="flex items-center space-x-2">
              <span className="text-xl font-black tracking-tight text-white">AvaxGuard</span>
              <span className="text-[10px] px-2 py-0.5 rounded-full font-mono bg-red-500/10 text-red-400 border border-red-500/20 font-semibold">
                Fuji C-Chain
              </span>
            </div>
            <p className="text-xs text-slate-400">On-Chain Policy Engine for Autonomous AI Agents</p>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-3 sm:space-x-4">
          <button
            ...
            className="hidden sm:flex items-center space-x-1.5 px-3 py-1.5 rounded-lg text-xs font-medium text-slate-300 bg-slate-900 border border-slate-800 hover:border-slate-700 hover:bg-slate-800 transition cursor-pointer"
          >
          ...
          {account && (
            ...
            >
              ...
              <span>{isFuji ? 'Fuji 43113' : 'Switch to Fuji'}</span>
            </button>
          )}
